        ...
        <form class="w-full " action="{{ route('cars.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="md:w-2/3 w-5/6 md:px-24 px-4 pb-8 mx-auto mt-2 space-y-12 bg-white border-2 border-gray-600 rounded-md">
                <div class="pb-12 border-b border-gray-900/10">
                    <h2 class="mt-2 text-lg font-bold leading-7 text-center text-gray-900">Remplissez les détails de la nouvelle voiture
                    </h2>
                    ...
                    <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="model" class="block text-sm font-medium leading-6 text-gray-900">Modèle</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            <label for="engine" class="block text-sm font-medium leading-6 text-gray-900">Moteur</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="quantity" class="block text-sm font-medium leading-6 text-gray-900">Quantité</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="price_per_day" class="block text-sm font-medium leading-6 text-gray-900">Prix par jour</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="" class="block text-sm font-medium leading-6 text-gray-900">Réduction %
                            </label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="stars" class="block text-sm font-medium leading-6 text-gray-900">Étoiles de la voiture</label>
                            <div class="mt-2">
...
<!-- Champ pour Type de boîte -->
<div class="sm:col-span-3">
    <label for="gearbox_type" class="block text-sm font-medium leading-6 text-gray-900">Type de boîte</label>
    <div class="mt-2">
    ...
    @enderror
                        ...
                        <div class="col-span-full">
                            <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Photo de couverture
                            </label>
                            <div
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="flex mt-4 text-sm leading-6 text-gray-600">
                                        ...
                                        <p class="pl-1">ou faites-le glisser ici</p>
                                    </div>
                ...
                <div class="flex items-center justify-center mb-6 gap-x-6">
                    <a href="{{route('cars.index')}}"
                        class="w-20 p-1 text-sm font-semibold leading-6 text-center text-gray-900 border-2 rounded-md border-pr-200 hover:bg-white bg-sec-300">Annuler</a>
                    <button type="submit"
                        class="w-1/3 px-3 py-2 text-sm font-semibold text-white rounded-md shadow-sm bg-pr-400 hover:bg-pr-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pr-400">Enregistrer</button>
                </div>
