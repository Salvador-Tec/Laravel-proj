...
<html
  ...
  <head>
    ...
    <!-- Core CSS -->
    <!-- build:css/vendor/css/theme.css  -->
  ...
  <body>
     ...
     />
        ...
        <div class="d-flex col-12 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
          <div class="w-px-400 mx-auto mt-12 pt-5">
            ...
            <p class="mb-6">Sign in to access the administration panel</p>

            <form id="formAuthentication" class="mb-6" method="POST" action="{{ route('admin.login') }}">
              @csrf
              <div class="mb-6 form-control-validation">
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  value="{{ old('email', 'test_admin@email.com') }}"
              ...
              <button type="submit" class="btn btn-primary d-grid w-100">Login to admin dashboard</button>
            </form>
          </div>
        </div>
        <!-- /Login -->
    ...
    <script src="../../vendor/libs/@algolia/autocomplete-js.js"></script>
