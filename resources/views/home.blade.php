...
@if (session('success_reservation'))
    <script>
        (function(){
            const r = @json(session('success_reservation'));
            function fire(){
                Swal.fire({
                    icon: 'success',
                    ...
                    html: `
                        <div style="text-align:left">
                            <p><strong>Voiture:</strong> ${r.car}</p>
                            <p><strong>Période:</strong> ${r.start_date} → ${r.end_date}</p>
                            <p><strong>Montant estimé:</strong> ${r.total_price} DT</p>
                            ${r.code ? `<p><strong>Code:</strong> ${r.code}</p>` : ''}
                        </div>
                    `,
                        ...
                        <div class="slide-item-content">
                            <div class="slide-content">
                                <span class="wow fadeInUp sub-title" data-wow-delay="100ms"
                                    data-wow-duration="2000ms">Concessionnaire de confiance, location</span>
                                <h1 class=" title-slide wow slideInUp" data-wow-delay="50ms" data-wow-duration="200ms">
                                Collection de voitures haut de gamme..</h1>
                                <p class="description wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                                La voiture est l'endroit où les premiers utilisateurs et les chercheurs
                                 d'innovation trouvent des technologies
                                 imaginatives et dynamiques avant qu'elles ne deviennent courantes.</p>
                                <div class="box">
                                    <!-- Button -->
                                    <div class="btn-main wow fadeInUp" data-wow-delay="400ms"
                                        data-wow-duration="2000ms">
                                        <a href="/car-list" class="button_main_inner ">
                                            <span>
                                            réservez maintenant
                                            </span>
                                        </a>
                            ...
                            <div class="slide-image">
                                <img src="assets/images/slide/icon.png" class="icon-shape wow swing" alt="">
                                <div class="box-offer">
                                    <p>40 <span>%</span></p>
                                    <span>off</span>
                                </div>
                    ...
                    <div class="search-form-widget">
                        ...
                        <div class="tab-content" id="myTabContent">
                                ...
                                <form action="{{ route('cars.available') }}" method="GET" >
                                    <div class="inner-group grid">
                                        <div class="form-group">
                                            <div class="group-select">
                                                <div class="nice-select" tabindex="0">
                                                    <span class="current">lieu de depart</span>
                                                    <ul class="list">
                                                        <li value="tunis" class="option">Tunis</li>
                                                        <li value="nabeul" class="option">Nabeul</li>
                                                        <li value="ariana" class="option">Ariana</li>
                                                        <li value="Béja" class="option">Béja</li>
                                                        <li value="Ben Arous" class="option"> Ben Arous</li>
                                                        <li value="Bizerte" class="option">Bizerte</li>
                                                        <li value="Gabès" class="option">Gabès</li>
                                                        <li value="Gafsa" class="option">Gafsa</li>
                                                        <li value="Jendouba" class="option">Jendouba</li>
                                                        <li value="Kairouan" class="option">Kairouan</li>
                                                        <li value="Kasserine" class="option">Kasserine</li>
                                                        <li value="Kébili" class="option">Kébili</li>
                                                        <li value="Kef" class="option">Kef</li>
                                                        <li value="Mahdia" class="option">Mahdia</li>
                                                        <li value="Manouba" class="option">Manouba</li>
                                                        <li value="Monastir" class="option">Monastir</li>
                                                        <li value="Sfax" class="option">Sfax</li>
                                                        <li value="Sidi Bouzid" class="option">Sidi Bouzid</li>
                                                        <li value="Siliana" class="option">Siliana</li>
                                                        <li value="Sousse" class="option">Sousse</li>
                                                        <li value="Tataouine" class="option">Tataouine</li>
                                                        <li value="Tozeur" class="option">Tozeur</li>
                                                        <li value="Zaghouan" class="option">Zaghouan</li> 
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="group-select">
                                                <div class="nice-select" tabindex="0">
                                                    <span class="current">lieu de retour</span>
                                                    <ul class="list">
                                                        <li value="tunis" class="option">Tunis</li>
                                                        <li value="Nabeul" class="option">Nabeul</li>
                                                        <li value="Ariana" class="option">Ariana</li>
                                        ...
                                        <div class="form-group">
                                            <div id="datepicker-depart" class="input-group date" data-date-format="dd-mm-yyyy">
                                                <input class="form-control date-input" type="text" name="start_date" placeholder="Date de départ" readonly required>
                                                <span class="input-group-addon">
                                                    <i class="fa-solid fa-calendar-days"></i>
                                                </span>
                                            </div>
                                                <input class="form-control time-input" type="time" name="delivery_time" placeholder="Heure de départ" required onchange="syncReturnTime()">
                                               
                                            
                                        <div class="form-group">
                                            <div id="datepicker-retour" class="input-group date" data-date-format="dd-mm-yyyy">
                                                <input class="form-control date-input" type="text" name="end_date" placeholder="Date de retour" readonly required>
                                                <span class="input-group-addon">
                                                    <i class="fa-solid fa-calendar-days"></i>
                                                </span>
                                            </div>
                                            
                                                <input class="form-control time-input" type="time" name="return_time" placeholder="Heure de retour" required >
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <form method="GET" id="search-forms2">
                                    <div class="inner-group grid">
                                        <div class="form-group">
                                            <div class="group-select">
                                                <div class="nice-select" tabindex="0">
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <form method="GET" id="search-forms3">
                                    <div class="inner-group grid">
                                        <div class="form-group">
                                            <div class="group-select">
                                                <div class="nice-select" tabindex="0">
            ...
            <div class="widget-icon-box mt--115">
                <div class="themesflat-container">
                    <div class="heading-section t-al-center mb-30">
                        <span class="sub-title mb-6 wow fadeInUp">Trouvez votre voiture par marque de voiture</span>
                        <h2 class="title wow fadeInUp">Parcourir par marques</h2>
                    </div>
                    <div class="row">
                ...
                <div class="themesflat-container">
                    <div class="header-section tab-car-service">
                        <div class="heading-section">
                            <span class="sub-title mb-6 wow fadeInUp">Service de concessionnaire automobile de confiance</span>
                            <h2 class="title wow fadeInUp">Explorez tous les véhicules</h2>
                        </div>
            ...
            <div class="widget-car-list-v2">
                <div class="themesflat-container">
                    <div class="header-tab mb-46">
                        <div class="heading-section">
                            <span class="sub-title mb-10 wow fadeInUp">Service de concessionnaire automobile de confiance</span>
                            <h2 class="title wow fadeInUp">Marques populaires</h2>
                        </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-6 col-xl-6">
                                    <div class="tf-car-service-v2">
                                        <a href="listing-details.html" class="image">
                                            ...
                                            <div class="thumb">
                                                <img src="assets/images/cart-service/1.jpg" class="img-responsive"
                                ...
                                <div class="col-12 col-sm-6 col-md-6 col-xl-6">
                                    <div class="tf-car-service-v2">
                                        <a href="listing-details.html" class="image">
                                            ...
                                            <div class="thumb">
                                                <img src="assets/images/cart-service/2.jpg" class="img-responsive"
                                                    alt="Image Car Service">
                                            </div>
                                        </a>
                                        <div class="content">
                    ...
                    <div class="counter-car">
                        <div class="counter-car-header-wrap">
                            <div class="counter-car-header">
                                <span class="sub-heading wow fadeInUp">Trouvez votre voiture</span>
                                <h2 class="title wow fadeInUp">Leader des meilleurs concessionnaires automobiles à Nabeul</h2>
                            </div>
                            <div class="counter-car-content">
                                <p class="description wow fadeInUp">Il existe de nombreuses variantes de passages de Lorem en texte libre, 
                                    mais la majorité d'entre elles ont subi une altération sous une forme 
                                    ou une autre par l'injection de mots aléatoires qui ne sont pas légèrement différents.
                                </p>
                            </div>
                        </div>
                        <div class="counter-wrap tf-counter mb--25">
                            <div class="widget-counter t-al-center counter-v1">
                                ...
                                <p>Véhicule en stock Voitures</p>
                            </div>
                            <div class="widget-counter t-al-center counter-v1">
                                ...
                                <div class="number-counter number" data-to="350" data-speed="2000"
                                    data-waypoint-active="yes">
                                    350<span>%</span></div>
                ...
                <div class="themesflat-container full">
                    <div class="feature-car">
                        <div class="feature-car-content">
                            <div class="heading-section">
                                <span class="sub-title mb-6 wow fadeInUp">Service de concessionnaire automobile de confiance</span>
                                <h2 class="title mb-40 wow fadeInUp">Foire aux questions et zone de questions..     </h2>
                                <p class="description wow fadeInUp">Depuis 15 ans, nous élevons la qualité de la location de voitures 
                                    grâce à l'une des solutions 
                                    les plus innovantes et les plus fiables.
                                </p>
                            </div>
                            <div class="list-icon-check">
                                <ul>
                                    <li>
                                        ...
                                        <p>nous sommes la meilleure agence de location de voitures avec un excellent service</p>
                                    </li>
                                    <li>
                                        <i class="icon-Vector-32"></i>
                                        <p>Obtenez le meilleur service de super entretien pour votre voiture et votre service de location</p>
                                    </li>
                                    <li>
                                        <i class="icon-Vector-32"></i>
                                        <p>Mécanicien expert pour l'installation et l'entretien de voitures et de locations</p>
                                    </li>
                                </ul>
                            </div>
                            <div class="btn-main">
